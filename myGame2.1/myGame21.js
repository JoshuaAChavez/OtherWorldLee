...
game_state.main.prototype = {
    ...
    preload: function() {
        ...
        game.load.spritesheet('office', 'assets/office.png', 800, 600);
    },
    create: function() {
        ...
        this.negativeText = game.add.text(140, 55, 'Keep to self', { fontSize: '32px', fill: '#000' });
        this.negativeText.visible = false;

        // creates lee's positive choices
        this.positiveText = game.add.text(440, 55, 'Join', { fontSize: '32px', fill: '#000' });
        this.positiveText.visible = false;

        // creates the boss' dialogue
        this.bossText = game.add.text(140, 300, 'You have to go to for inspection', { fontSize: '32px', fill: 'FF0000' });
    ...
    chekDialogue: function(userzey) {
        // Dialogue
        var negDialogue = ["Unfulfilled."];
        var posDialogue = ["Heys guy what ups"];
        var bossDialogue = [
